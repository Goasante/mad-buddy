 ...
 *
 * Every function here resolves the caller's real user id from the cookie
 * session and hands it to the canonical service. Linkr is part of the free
 * product; Mad Buddy Access affects advertising and is deliberately absent
 * from these actions.
 *
