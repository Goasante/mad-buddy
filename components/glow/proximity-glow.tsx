...
export function ProximityGlow({
  ...
  const style = {
    ...
    // Sized to the furthest any layer reaches AT ITS ANIMATION PEAK, not to
    // the static field: the expanding wave and the breathing core both travel
    // outward past their own diameter, so a field-sized box would crop Right
    // Here -- the one state that must never look clipped.
