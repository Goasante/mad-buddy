...
export function RichMediaMessageV4({
  ...
  if (!media) {
    return (
      <div className="mb-2 flex min-h-20 min-w-[220px] items-center gap-3 rounded-2xl border border-current/10 px-3 py-3 text-xs opacity-70">
  ...
  if (media.kind === "video") {
    return (
      <div className="mb-2 overflow-hidden rounded-2xl bg-black shadow-sm">
        <video
          controls
          playsInline
          preload="metadata"
  ...
  return (
    <div className={`mb-2 min-w-[230px] rounded-2xl border p-3 ${mine ? "border-white/15 bg-white/[0.08]" : "border-black/[0.06] bg-black/[0.025] dark:border-white/[0.08] dark:bg-white/[0.04]"}`}>
